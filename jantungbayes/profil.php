...
<table width="100%" border="0" align="center">
  <tr>
    <td width="200" rowspan="6" bordercolor="#FF00FF" bgcolor="#FFFFFF"><img src="images/haid.png" width="185" height="171" border="0"></td>
    <td width="136" height="29"><span class="style7 style13">Nama</span></td>
    <td width="8"><span class="style13"><strong>:</strong></span></td>
    <td width="235"><span class="style7 style13">Fitra Ariana</span></td>
  </tr>
  <tr>
    <td height="28"><span class="style7 style13">NIM</span></td>
    <td><span class="style13"><strong>:</strong></span></td>
    <td><span class="style7 style13">10110061</span></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><span class="style13"><strong>:</strong></span></td>
    <td><span class="style7 style13">Teupin Keubeu, 03 Mei 1992 </span></td>
  </tr>
  <tr>
    <td height="28"><span class="style7 style13">Alamat</span></td>
    <td><span class="style13"><strong>:</strong></span></td>
    <td><span class="style7 style13">Teupin Keubeu</span></td>
  </tr>
</table>
</div>
