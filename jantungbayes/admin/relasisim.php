...
$sql_cek = "SELECT * FROM tbrule WHERE kd_penyakit='$TxtKdPenyakit' AND kd_gejala='$TxtKdGejala'";
...
$sqltes = "SELECT * FROM tbgejala WHERE kd_gejala='$TxtKdGejala'";
$qrytes = mysqli_query($koneksi,$sqltes );
while ($data_tmp = mysqli_fetch_array($qrytes)){

$sql  = " INSERT INTO tbrule (kd_penyakit,kd_gejala,bobot) VALUES ('$TxtKdPenyakit','$TxtKdGejala','$bobot')"; 
}
