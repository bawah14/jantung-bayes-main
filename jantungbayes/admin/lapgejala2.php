...
$sqlp = "SELECT * FROM tbpenyakit WHERE kd_penyakit='$kdsakit' ";
...
<table width="650" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#99CC99">
  ...
  <?php 
	$sqlg  = "SELECT * FROM tbgejala,tbrule ";
	$sqlg .= "WHERE tbgejala.kd_gejala=tbrule.kd_gejala ";
	$sqlg .= "AND  tbrule.kd_penyakit='$kdsakit' ";
	$sqlg .= "ORDER BY tbgejala.kd_gejala";
