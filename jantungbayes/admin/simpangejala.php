...
$gejala=$_POST['gejala'];
$sqlrs=mysqli_query($koneksi,"SELECT kd_gejala FROM tbgejala WHERE kd_gejala='$kd_gejala'");
$rs=mysqli_num_rows($sqlrs);
if($rs==0){
	// jika data nol maka simpan data
	$perintah="INSERT INTO tbgejala (kd_gejala,gejala) VALUES ('$kd_gejala','$gejala')";
	...
	if ($berhasil){
		...
		echo "<center><a href='haladmin.php?top=gejala.php'>Kembali</a></center>";
		}
	}else{
