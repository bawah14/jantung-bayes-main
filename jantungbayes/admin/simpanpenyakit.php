...
$solusi=$_POST['solusi'];
//cek keberadaan data
$sqlrs=mysqli_query($koneksi,"SELECT kd_penyakit FROM tbpenyakit WHERE kd_penyakit='$kd_penyakit'");
$rs=mysqli_num_rows($sqlrs);
if($rs==0){
	$perintah="INSERT INTO tbpenyakit(kd_penyakit,nama_penyakit,definisi,solusi)VALUES('$kd_penyakit','$nama_penyakit','$definisi','$solusi')";
