...
<div id="art-main">
    ...
    <div class="art-header-inner">
        ...
        <div class="art-logo">
                 <h1 class="art-logo-name"><a href="./index.php?top=home.php">IDENTIFIKASI TUMBUH KEMBANG ANAK </a></h1>
                 <h1 class="art-logo-name"><a href="./index.php?top=home.php">USIA DINI/BALITA </a></h1>
                 <h2 class="art-logo-text">Menggunakan Metode Bayes</h2>
        </div>
    </div>
    </div>
    </div>
